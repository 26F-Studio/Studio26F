...
using namespace drogon_model::studio26f;
...
Player::Player(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[7].empty() && pJson.isMember(pMasqueradingVector[7]))
    {
        ...
        {
            permission_=std::make_shared<std::string>(pJson[pMasqueradingVector[7]].asString());
        }
    }
    ...
    if(!pMasqueradingVector[9].empty() && pJson.isMember(pMasqueradingVector[9]))
    {
        ...
        {
            email_=std::make_shared<std::string>(pJson[pMasqueradingVector[9]].asString());
        }
    }
...
void Player::setRegionToNull() noexcept
{
    region_.reset();
    dirtyFlag_[3] = true;
}
...
void Player::setAvatarFrameToNull() noexcept
{
    avatarFrame_.reset();
    dirtyFlag_[6] = true;
}
...
void Player::setPermissionToNull() noexcept
{
    permission_.reset();
    dirtyFlag_[7] = true;
}
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 11)
    {
        ...
        if(!pMasqueradingVector[7].empty())
        {
            if(getPermission())
            {
                ret[pMasqueradingVector[7]]=getValueOfPermission();
            }
            else
            {
        ...
        if(!pMasqueradingVector[9].empty())
        {
            if(getEmail())
            {
                ret[pMasqueradingVector[9]]=getValueOfEmail();
            }
            else
            {
...
bool Player::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("permission"))
    {
        if(!validJsonOfField(7, "permission", pJson["permission"], err, true))
            return false;
    }
    if(pJson.isMember("password_hash"))
    {
    ...
    if(pJson.isMember("email"))
    {
        if(!validJsonOfField(9, "email", pJson["email"], err, true))
            return false;
    }
    if(pJson.isMember("phone"))
    {
...
bool Player::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("permission"))
    {
        if(!validJsonOfField(7, "permission", pJson["permission"], err, false))
            return false;
    }
    if(pJson.isMember("password_hash"))
    {
    ...
    if(pJson.isMember("email"))
    {
        if(!validJsonOfField(9, "email", pJson["email"], err, false))
            return false;
    }
    if(pJson.isMember("phone"))
    {
